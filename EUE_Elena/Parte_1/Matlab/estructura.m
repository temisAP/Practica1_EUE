classdef estructura < handle
    ...
    methods
        ...
        function CB_reduction(obj,f_red)
            ...
            Min = CB_inner_decomp(obj,M{3,3});
            Kin = CB_inner_decomp(obj,K{3,3});
            
            % Eliminar el final de las submatrices
    ...
    methods (Access = private)
        ...
        function [C] = CB_inner_decomp(obj,M)
            
            component_s = obj.component_s;
            
            % Tamaño de las submatrices
            sub_matrix_number = length(component_s);                  % Número de submatrices    
            for c = 1:length(component_s)
